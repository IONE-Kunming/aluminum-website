export default {
  ...
  admin: {
    ...
    manageAllUsers: '管理所有平台用户（买家、卖家和管理员）',
    searchUsersPlaceholder: '按姓名或邮箱搜索用户...',
    allRoles: '所有角色',
    buyers: '买家',
    admins: '管理员',
    allStatus: '所有状态',
    ...
    bio: '简介',
    exportProfile: '导出资料',
    profileExported: '资料导出成功',
    exportAllUsers: '导出所有用户',
    exportingAllUsers: '正在导出所有用户...',
    allUsersExported: '所有用户导出成功',
    allUsersExportFailed: '导出所有用户失败',
    importProfileData: '导入资料数据',
    importedFields: '导入的字段',
    importTo: '导入到',
    existingUser: '现有用户',
    newUser: '新用户',
    selectUserFromList: '从列表中选择用户',
    chooseAUser: '-- 选择一个用户 --',
    emailRequiredForAccount: '邮箱（创建账户必填）',
    passwordMin6: '密码（至少6个字符）',
    enterPasswordPlaceholder: '为新账户输入密码',
    newAccountDescription: '将使用这些凭据创建新的Firebase账户，并应用导入的资料数据。',
    applyImport: '应用导入',
    pleaseSelectUser: '请从列表中选择用户',
    noValidFields: '导入文件中未找到有效的资料字段',
    profileImported: '资料导入成功',
    failedToImportProfile: '资料导入失败',
    emailRequiredForNewAccount: '创建新账户需要邮箱',
    pleaseEnterValidEmail: '请输入有效的邮箱地址',
    passwordMin6Error: '密码至少需要6个字符',
    creating: '创建中...',
    newAccountCreated: '新账户已创建并导入资料数据',
    emailAlreadyExists: '该邮箱的账户已存在。请使用"现有用户"模式。',
    failedToCreateAccount: '创建账户失败',
    invalidJsonFile: '无效的JSON文件',
    confirmDeleteData: '确定要删除以下数据吗？',
  ...
  finances: {
    dashboard: '财务仪表盘',
    dashboardSubtitle: '收入、支出和近期交易概览',
    dashboardNav: '仪表盘',
    transactions: '交易记录',
    chartOfAccounts: '科目表',
    reports: '报表',
    ...
    expenses: '支出',
    taxCollected: '已征税额',
    fromPreviousPeriod: '与上期持平',
    revenueVsExpenses: '收入与支出 — 近30天',
    revenue: '收入',
    ...
    amount: '金额',
    status: '状态',
    noRecentTransactions: '未找到近期交易。',
    quickActions: '快捷操作',
    reconcileNow: '立即对账',
    generateReports: '生成报表',
    exportStatements: '导出报表',
    taxFiling: '税务申报',
    exportStatementsComingSoon: '导出报表功能即将推出',
    viewAllTransactions: '查看所有财务交易',
    searchTransactionsPlaceholder: '按参考号、描述或金额搜索...',
    allTypes: '所有类型',
    sale: '销售',
    refund: '退款',
    expense: '支出',
    ...
    cancelled: '已取消',
    export: '导出',
    loadingTransactions: '加载交易记录中...',
    noTransactionsFound: '未找到交易记录',
    account: '账户',
    debit: '借方',
    credit: '贷方',
    order: '订单',
    showingTransactions: '显示 {shown} / {total} 条交易',
    noTransactionsToExport: '没有可导出的交易',
    transactionsExported: '交易已导出',
    manageAccountStructure: '管理您的科目结构',
    importCsv: '导入CSV',
    exportCsv: '导出CSV',
    addAccount: '添加科目',
    searchAccountsPlaceholder: '搜索科目...',
    assets: '资产',
    liabilities: '负债',
    equity: '权益',
    code: '代码',
    ...
    viewActivity: '查看活动',
    edit: '编辑',
    chartOfAccountsExported: '科目表已导出',
    addAccountComingSoon: '添加科目功能即将推出',
    importAccountsComingSoon: '导入科目表功能即将推出',
    accountCash: '现金',
    accountReceivable: '应收账款',
    accountInventory: '库存',
    accountPayable: '应付账款',
    accountTaxPayable: '应交税费',
    accountOwnersEquity: '所有者权益',
    accountSalesRevenue: '销售收入',
    accountShippingRevenue: '运输收入',
    accountCogs: '销售成本',
    accountShippingExpenses: '运输费用',
    accountPlatformFees: '平台费用',
    reportsCenter: '报表中心',
    generateAndViewReports: '生成和查看财务报表',
    profitAndLoss: '损益表',
    profitAndLossDesc: '一段时间内的收入、支出和净利润',
    balanceSheet: '资产负债表',
    balanceSheetDesc: '某一时点的资产、负债和权益',
    cashFlowStatement: '现金流量表',
    cashFlowStatementDesc: '经营活动中的现金流入和流出',
    trialBalance: '试算平衡表',
    trialBalanceDesc: '所有科目余额汇总',
    profitByProduct: '按产品利润',
    profitByProductDesc: '每个产品的盈利分析',
    profitByCategory: '按类别利润',
    profitByCategoryDesc: '按类别分组的收入和利润',
    taxLiabilityReport: '税务责任报告',
    taxLiabilityReportDesc: '已征收的税额和应付金额',
    accountsReceivableAging: '应收账款账龄',
    accountsReceivableAgingDesc: '按账龄划分的未收回应收款',
    accountsPayableAging: '应付账款账龄',
    accountsPayableAgingDesc: '按账龄划分的未付应付款',
    refundAnalysis: '退款分析',
    refundAnalysisDesc: '退款趋势和原因',
    runReport: '运行报表',
    lastNever: '上次: 从未',
    reportComingSoon: '报表生成功能即将推出',
    manageTaxRates: '管理税率并查看税务摘要',
    addTaxRate: '添加税率',
    collectedThisMonth: '本月已征收',
    dueThisQuarter: '本季度应付',
    paid: '已付',
    outstanding: '未付',
    jurisdiction: '管辖区',
    region: '地区',
    rate: '税率',
    applyToShipping: '适用于运费',
    yes: '是',
    no: '否',
    delete: '删除',
    generateTaxReport: '生成税务报告',
    generateTaxReportDesc: '为特定管辖区和期间生成符合申报要求的税务报告。',
    selectJurisdiction: '选择管辖区',
    generateReport: '生成报告',
    addTaxRateComingSoon: '添加税率功能即将推出',
    taxReportComingSoon: '税务报告生成功能即将推出',
    matchAndReconcile: '将交易与银行对账单进行匹配和对账',
    bankAccount: '银行账户',
    primaryBankAccount: '主要银行账户',
    secondaryAccount: '次要账户',
    totalInvoiced: '总开票额',
    totalPaid: '总已付额',
    difference: '差额',
    reconciliationProgress: '对账进度',
    matched: '已匹配',
    uploadBankStatement: '上传银行对账单（CSV）',
    completeReconciliation: '完成对账',
    invoiceNumber: '发票编号',
    noInvoicesForReconciliation: '没有可供对账的发票。',
    selectTransactionToReconcile: '请至少选择一笔交易进行对账',
    transactionsMarkedForReconciliation: '笔交易已标记为对账',
    bankStatementComingSoon: '银行对账单上传功能即将推出'
  },

  // 卖家支付方式
  paymentMethods: {
    title: '支付方式',
    description: '完善您的支付信息以接收IONE的付款。所有字段均为必填。',
    bankName: '银行名称',
    bankNamePlaceholder: '如：中国工商银行',
    accountHolderName: '账户持有人姓名',
    accountHolderPlaceholder: '账户上的全名',
    accountNumberIban: '账号/IBAN',
    accountNumberPlaceholder: '账号或IBAN',
    swiftBicCode: 'SWIFT/BIC代码',
    swiftPlaceholder: '如：ICBKCNBJ',
    bankBranchCity: '银行分行/城市',
    bankBranchPlaceholder: '如：深圳主支行',
    currency: '货币',
    additionalNotes: '额外支付备注',
    additionalNotesPlaceholder: '任何额外的支付说明（可选）',
    detailsComplete: '支付信息已完善 — 您有资格接收付款。',
    detailsIncomplete: '请完善您的支付信息以开始接收IONE的付款。',
    savePaymentDetails: '保存支付信息',
    savedSuccess: '支付信息保存成功',
    savedError: '保存支付信息失败',
    bankNameAccountRequired: '银行名称、账户名称、账号和SWIFT代码为必填项'
  },
